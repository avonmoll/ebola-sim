...
ebola_sim.settings.I0['Guinea'] = 500
...
def plot_results():
    ...
    for country, c_ave in ave_grouped:
        ...
        x = range(ebola_sim.settings.maxIter)
        a = 0.2
        ax[0].plot(range(ebola_sim.settings.maxIter), s_ave, 'b', e_ave, 'g', i_ave, 'r', h_ave, 'y', f_ave, 'k', r_ave, 'k--') 
